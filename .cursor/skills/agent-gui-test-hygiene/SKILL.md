---
name: agent-gui-test-hygiene
description: >-
  Prevents and diagnoses hung offscreen GUI tests (Qt, Electron, etc.) in agent-driven
  test runs. Use when Phase 2 GUI tests hang, QMessageBox blocks teardown, background
  workers outlive the test, or test_gui_* / offscreen harness is involved.
---
