...
description: >-
  Diagnoses and mitigates stuck Cursor agent terminals, stale terminal metadata,
  and interactive build pauses. Use when builds hang on pause, "taking longer than
  expected", zombie terminal tabs, or before/after agent-run shell commands.
---
