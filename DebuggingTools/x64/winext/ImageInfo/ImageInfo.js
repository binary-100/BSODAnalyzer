...
__defineSyntheticType("_IMAGE_DOS_HEADER",            [{fieldName: "e_magic", fieldType: "unsigned short"},
                                                       ...
                                                       {fieldName: "e_lfanew", fieldType: "unsigned int"}]);
...
__defineSyntheticType("_IMAGE_FILE_HEADER",           [{fieldName: "Machine", fieldType: "unsigned short"},
                                                       ...
                                                       {fieldName: "TimeDateStamp", fieldType: "unsigned int"},
                                                       {fieldName: "PointerToSymbolTable", fieldType: "unsigned int"},
                                                       {fieldName: "NumberOfSymbols", fieldType: "unsigned int"},
...
__defineSyntheticType("_IMAGE_OPTIONAL_HEADER32",     [{fieldName: "Magic", fieldType: "unsigned short"},
                                                       ...
                                                       {fieldName: "SizeOfCode", fieldType: "unsigned int"},
                                                       {fieldName: "SizeOfInitializedData", fieldType: "unsigned int"},
                                                       {fieldName: "SizeOfUninitializedData", fieldType: "unsigned int"},
                                                       {fieldName: "AddressOfEntryPoint", fieldType: "unsigned int"},
                                                       {fieldName: "BaseOfCode", fieldType: "unsigned int"},
                                                       {fieldName: "BaseOfData", fieldType: "unsigned int"},
                                                       {fieldName: "ImageBase", fieldType: "unsigned int"},
                                                       {fieldName: "SectionAlignment", fieldType: "unsigned int"},
                                                       {fieldName: "FileAlignment", fieldType: "unsigned int"},
                                                       ...
                                                       {fieldName: "Win32VersionValue", fieldType: "unsigned int"},
                                                       {fieldName: "SizeOfImage", fieldType: "unsigned int"},
                                                       {fieldName: "SizeOfHeaders", fieldType: "unsigned int"},
                                                       {fieldName: "CheckSum", fieldType: "unsigned int"},
                                                       {fieldName: "Subsystem", fieldType: "unsigned short"},
                                                       {fieldName: "DllCharacteristics", fieldType: "unsigned short"},
                                                       {fieldName: "SizeOfStackReserve", fieldType: "unsigned int"},
                                                       {fieldName: "SizeOfStackCommit", fieldType: "unsigned int"},
                                                       {fieldName: "SizeOfHeapReserve", fieldType: "unsigned int"},
                                                       {fieldName: "SizeOfHeapCommit", fieldType: "unsigned int"},
                                                       {fieldName: "LoaderFlags", fieldType: "unsigned int"},
                                                       {fieldName: "NumberOfRvaAndSizes", fieldType: "unsigned int"},
...
__defineSyntheticType("_IMAGE_DATA_DIRECTORY",        [{fieldName: "VirtualAddress", fieldType: "unsigned int"},
                                                       {fieldName: "Size", fieldType: "unsigned int"}]);
...
__defineSyntheticType("_IMAGE_RESOURCE_DIRECTORY",    [{fieldName: "Characteristics", fieldType: "unsigned int"},
                                                       {fieldName: "TimeDateStamp", fieldType: "unsigned int"},
...
__defineSyntheticType("_IMAGE_EXPORT_DIRECTORY",      [{fieldName: "Characteristics", fieldType: "unsigned int"},
                                                       {fieldName: "TimeDateStamp", fieldType: "unsigned int"},
                                                       {fieldName: "MajorVersion", fieldType: "unsigned short"},
                                                       {fieldName: "MinorVersion", fieldType: "unsigned short"},
                                                       {fieldName: "Name", fieldType: "unsigned int"},
                                                       {fieldName: "Base", fieldType: "unsigned int"},
                                                       {fieldName: "NumberOfFunctions", fieldType: "unsigned int"},
                                                       {fieldName: "NumberOfNames", fieldType: "unsigned int"},
                                                       {fieldName: "AddressOfFunctions", fieldType: "unsigned int"},
                                                       {fieldName: "AddressOfNames", fieldType: "unsigned int"},
                                                       {fieldName: "AddressOfNameOrdinals", fieldType: "unsigned int"}]);

__defineSyntheticUnion("__UNNAMED_IIDUNION",          [{fieldName: "OriginalFirstThunk", fieldType: "unsigned int"},
                                                       {fieldName: "Characteristics", fieldType: "unsigned int"}]);

__defineSyntheticType("_IMAGE_IMPORT_DESCRIPTOR",     [{fieldSyntheticType: "__UNNAMED_IIDUNION"},
                                                       {fieldName: "TimeDateStamp", fieldType: "unsigned int"},
                                                       {fieldName: "ForwarderChain", fieldType: "unsigned int"},
                                                       {fieldName: "Name", fieldType: "unsigned int"},
                                                       {fieldName: "FirstThunk", fieldType: "unsigned int"}]);
...
__defineSyntheticType("_IMAGE_RESOURCE_DATA_ENTRY",   [{fieldName: "OffsetToData", fieldType: "unsigned int"},
                                                       {fieldName: "Size", fieldType: "unsigned int"},
                                                       {fieldName: "CodePage", fieldType: "unsigned int"},
                                                       {fieldName: "Reserved", fieldType: "unsigned int"}]);

__defineSyntheticType("__UNNAMED_IDD_ATTSTRUCT",      [{fieldName: "RvaBased", fieldType: "unsigned int", bitLength: 1},
                                                       {fieldName: "ReservedAttributes", fieldType: "unsigned int", bitLength: 31}]);

__defineSyntheticUnion("__IDD_ATTUNION",              [{fieldName: "AllAttributes", fieldType: "unsigned int"},
...
__defineSyntheticType("_IMAGE_DELAYLOAD_DESCRIPTOR",  [{fieldName: "Attributes", fieldSyntheticType: "__IDD_ATTUNION"},
                                                       {fieldName: "DllNameRVA", fieldType: "unsigned int"},
                                                       {fieldName: "ModuleHandleRVA", fieldType: "unsigned int"},
                                                       {fieldName: "ImportAddressTableRVA", fieldType: "unsigned int"},
                                                       {fieldName: "ImportNameTableRVA", fieldType: "unsigned int"},
                                                       {fieldName: "BoundImportAddressTableRVA", fieldType: "unsigned int"},
                                                       {fieldName: "UnloadInformationTableRVA", fieldType: "unsigned int"},
                                                       {fieldName: "TimeDateStamp", fieldType: "unsigned int"}]);

__defineSyntheticType("__UNNAMED_IRDE_UNION1_STRUCT", [{fieldName: "NameOffset", fieldType: "unsigned int", bitLength: 31},
                                                       {fieldName: "NameIsString", fieldType: "unsigned int", bitLength: 1}]);
...
__defineSyntheticType("__UNNAMED_IRDE_UNION2_STRUCT", [{fieldName: "OffsetToDirectory", fieldType: "unsigned int", bitLength: 31},
                                                       {fieldName: "DataIsDirectory", fieldType: "unsigned int", bitLength: 1}]);

__defineSyntheticUnion("__UNNAMED_IRDE_UNION2",       [{fieldName: "OffsetToData", fieldType: "unsigned int"},
...
__defineSyntheticType("VS_FIXEDFILEINFO", [{fieldName: "dwSignature", fieldType: "unsigned int"},
                                           {fieldName: "dwStrucVersion", fieldType: "unsigned int"},
                                           {fieldName: "dwFileVersionMS", fieldType: "unsigned int"},
                                           {fieldName: "dwFileVersionLS", fieldType: "unsigned int"},
                                           {fieldName: "dwProductVersionMS", fieldType: "unsigned int"},
                                           {fieldName: "dwProductVersionLS", fieldType: "unsigned int"},
                                           {fieldName: "dwFileFlagsMask", fieldType: "unsigned int"},
                                           {fieldName: "dwFileFlags", fieldType: "unsigned int"},
                                           {fieldName: "dwFileOS", fieldType: "unsigned int"},
                                           {fieldName: "dwFileType", fieldType: "unsigned int"},
                                           {fieldName: "dwFileSubtype", fieldType: "unsigned int"},
                                           {fieldName: "dwFileDateMS", fieldType: "unsigned int"},
                                           {fieldName: "dwFileDateLS", fieldType: "unsigned int"}]);

__defineSyntheticType("_IMAGE_DEBUG_DIRECTORY", [{fieldName: "Characteristics", fieldType: "unsigned int"},
                                                 {fieldName: "TimeDateStamp", fieldType: "unsigned int"},
                                                 {fieldName: "MajorVersion", fieldType: "unsigned short"},
                                                 {fieldName: "MinorVersion", fieldType: "unsigned short"},
                                                 {fieldName: "Type", fieldType: "unsigned int"},
                                                 {fieldName: "SizeOfData", fieldType: "unsigned int"},
                                                 {fieldName: "AddressOfRawData", fieldType: "unsigned int"},
                                                 {fieldName: "PointerToRawData", fieldType: "unsigned int"}]);
...
__defineSyntheticType("___ELF_HEADER32", [{fieldName: "Identifier", fieldType: "unsigned char[4]"}, // e_ident 0-3
                                          ...
                                          {fieldName: "ELFVersion", fieldType: "unsigned int"},     // e_version
                                          {fieldName: "Entry", fieldType: "unsigned int"},          // e_entry
                                          {fieldName: "OffsetPHdr", fieldType: "unsigned int"},     // e_phoff
                                          {fieldName: "OffsetSHdr", fieldType: "unsigned int"},     // e_shoff
                                          {fieldName: "Flags", fieldType: "unsigned int"},          // e_flags
...
__defineSyntheticType("___ELF_SECTIONHEADER32", [{fieldName: "Name", fieldType: "unsigned int"},    // sh_name
                                                 {fieldName: "Type", fieldType: "unsigned int"},    // sh_type
                                                 {fieldName: "Flags", fieldType: "unsigned int"},   // sh_flags
                                                 {fieldName: "Address", fieldType: "unsigned int"}, // sh_addr
                                                 {fieldName: "Offset", fieldType: "unsigned int"},  // sh_offset
                                                 {fieldName: "Size", fieldType: "unsigned int"},    // sh_size
                                                 {fieldName: "Link", fieldType: "unsigned int"},    // sh_link
                                                 {fieldName: "Info", fieldType: "unsigned int"},    // sh_info
                                                 {fieldName: "Align", fieldType: "unsigned int"},   // sh_addralign
                                                 {fieldName: "EntSize", fieldType: "unsigned int"}]); // sh_entsize
 
__defineSyntheticType("___ELF_SECTIONHEADER64", [{fieldName: "Name", fieldType: "unsigned int"},    // sh_name
                                                 {fieldName: "Type", fieldType: "unsigned int"},    // sh_type
...
__defineSyntheticType("___ELF_PROGRAMHEADER32", [{fieldName: "Type", fieldType: "unsigned int"},     // p_type
                                                 {fieldName: "Offset", fieldType: "unsigned int"},   // p_offset
                                                 {fieldName: "VAddr", fieldType: "unsigned int"},    // p_vaddr
                                                 {fieldName: "PAddr", fieldType: "unsigned int"},    // p_paddr
                                                 {fieldName: "FileSize", fieldType: "unsigned int"}, // p_filesz
                                                 {fieldName: "MemSize", fieldType: "unsigned int"},  // p_memsz
                                                 {fieldName: "Flags", fieldType: "unsigned int"},    // p_flags
                                                 {fieldName: "Align", fieldType: "unsigned int"}]);  // p_align

__defineSyntheticType("___ELF_PROGRAMHEADER64", [{fieldName: "Type", fieldType: "unsigned int"},     // p_type
                                                 {fieldName: "Flags", fieldType: "unsigned int"},    // p_flags
...
__defineSyntheticType("___ELF_NOTE", [{fieldName: "NameSize", fieldType: "unsigned int"},            // n_namesz
                                      {fieldName: "DescSize", fieldType: "unsigned int"},            // n_descsz
                                      {fieldName: "Type", fieldType: "unsigned int"}]);              // n_type

__defineSyntheticType("___ELF_DYNAMICENTRY32", [{fieldName: "Tag", fieldType: "unsigned int"},
                                                {fieldName: "Val", fieldType: "unsigned int"}]);
...
__defineSyntheticType("___ELF_RDEBUG32", [{fieldName: "Version", fieldType: "int"},
                                          {fieldName: "Padding", fieldType: "int"},
                                          {fieldName: "AddrRMap", fieldType: "unsigned int"},
                                          {fieldName: "RBrk", fieldType: "unsigned int"}]);
...
__defineSyntheticType("___ELF_LINKMAPENTRY32", [{fieldName: "LAddr", fieldType: "unsigned int"},
                                                {fieldName: "LName", fieldType: "unsigned int"},
                                                {fieldName: "LDyn", fieldType: "unsigned int"},
                                                {fieldName: "LNext", fieldType: "unsigned int"}]);

__defineSyntheticType("___MACH_HEADER32", [{fieldName: "magic", fieldType: "unsigned int"},
                                           {fieldName: "cputype", fieldType: "unsigned int"},
                                           {fieldName: "cpusubtype", fieldType: "unsigned int"},
                                           {fieldName: "filetype", fieldType: "unsigned int"},
                                           {fieldName: "ncmds", fieldType: "unsigned int"},
                                           {fieldName: "sizeofcmds", fieldType: "unsigned int"},
                                           {fieldName: "flags", fieldType: "unsigned int"}]);

__defineSyntheticType("___MACH_HEADER64", [{fieldName: "magic", fieldType: "unsigned int"},
                                           {fieldName: "cputype", fieldType: "unsigned int"},
                                           {fieldName: "cpusubtype", fieldType: "unsigned int"},
                                           {fieldName: "filetype", fieldType: "unsigned int"},
                                           {fieldName: "ncmds", fieldType: "unsigned int"},
...
__defineSyntheticType("___load_command", [{fieldName: "cmd", fieldType: "unsigned int"},
                                          {fieldName: "cmdsize", fieldType: "unsigned int"}]);

__defineSyntheticType("___segment_command", [{fieldName: "cmd", fieldType: "unsigned int"},
                                             {fieldName: "cmdsize", fieldType: "unsigned int"},
                                             {fieldName: "segname", fieldType: "char[16]"},
                                             {fieldName: "vmaddr", fieldType: "unsigned int"},
                                             {fieldName: "vmsize", fieldType: "unsigned int"},
                                             {fieldName: "fileoff", fieldType: "unsigned int"},
                                             {fieldName: "filesize", fieldType: "unsigned int"},
                                             {fieldName: "maxprot", fieldType: "unsigned int"},
                                             {fieldName: "initprot", fieldType: "unsigned int"},
                                             {fieldName: "nsects", fieldType: "unsigned int"},
                                             {fieldName: "flags", fieldType: "unsigned int"}]);

__defineSyntheticType("___segment_command_64", [{fieldName: "cmd", fieldType: "unsigned int"},
                                                {fieldName: "cmdsize", fieldType: "unsigned int"},
                                                {fieldName: "segname", fieldType: "char[16]"},
...
__defineSyntheticType("___section", [{fieldName: "sectname", fieldType: "char[16]"},
                                     {fieldName: "segname", fieldType: "char[16]"},
                                     {fieldName: "addr", fieldType: "unsigned int"},
                                     {fieldName: "size", fieldType: "unsigned int"},
                                     {fieldName: "offset", fieldType: "unsigned int"},
                                     {fieldName: "align", fieldType: "unsigned int"},
                                     {fieldName: "reloff", fieldType: "unsigned int"},
                                     {fieldName: "nreloc", fieldType: "unsigned int"},
                                     {fieldName: "flags", fieldType: "unsigned int"},
                                     {fieldName: "reserved1", fieldType: "unsigned int"},
                                     {fieldName: "reserved2", fieldType: "unsigned int"}]);
...
__defineSyntheticType("___section_64", [{fieldName: "sectname", fieldType: "char[16]"},
                                        ...
                                        {fieldName: "reserved1", fieldType: "unsigned int"},
                                        {fieldName: "reserved2", fieldType: "unsigned int"},
                                        {fieldName: "reserved3", fieldType: "unsigned int"}]);

__defineSyntheticType("___uuid_command", [{fieldName: "cmd", fieldType: "unsigned int"},
                                          {fieldName: "cmdsize", fieldType: "unsigned int"},
                                          {fieldName: "uuid", fieldSyntheticType: "GUID"}]);

__defineSyntheticType("___build_version_command", [{fieldName: "cmd", fieldType: "unsigned int"},
                                                   {fieldName: "cmdsize", fieldType: "unsigned int"},
                                                   {fieldName: "platform", fieldType: "unsigned int"},
                                                   {fieldName: "minos", fieldType: "unsigned int"},
                                                   {fieldName: "sdk", fieldType: "unsigned int"},
                                                   {fieldName: "ntools", fieldType: "unsigned int"}]);

__defineSyntheticType("___build_tool_version", [{fieldName: "tool", fieldType: "unsigned int"},
                                                {fieldName: "version", fieldType: "unsigned int"}]);

__defineSyntheticType("___dylib", [{fieldName: "name", fieldType: "unsigned int"},
                                   {fieldName: "timestamp", fieldType: "unsigned int"},
                                   {fieldName: "current_version", fieldType: "unsigned int"},
                                   {fieldName: "compatibility_version", fieldType: "unsigned int"}]);

__defineSyntheticType("___dylib_command", [{fieldName: "cmd", fieldType: "unsigned int"},
                                           {fieldName: "cmdsize", fieldType: "unsigned int"},
                                           {fieldName: "dylib", fieldSyntheticType: "___dylib"}]);

__defineSyntheticType("___dyld_info_command", [{fieldName: "cmd", fieldType: "unsigned int"},
                                               {fieldName: "cmdsize", fieldType: "unsigned int"},
                                               {fieldName: "rebase_off", fieldType: "unsigned int"},
                                               {fieldName: "rebase_size", fieldType: "unsigned int"},
                                               {fieldName: "bind_off", fieldType: "unsigned int"},
                                               {fieldName: "bind_size", fieldType: "unsigned int"},
                                               {fieldName: "weak_bind_off", fieldType: "unsigned int"},
                                               {fieldName: "weak_bind_size", fieldType: "unsigned int"},
                                               {fieldName: "lazy_bind_off", fieldType: "unsigned int"},
                                               {fieldName: "lazy_bind_size", fieldType: "unsigned int"},
                                               {fieldName: "export_off", fieldType: "unsigned int"},
                                               {fieldName: "export_size", fieldType: "unsigned int"}]);

__defineSyntheticType("___dysymtab_command", [{fieldName: "cmd", fieldType: "unsigned int"},
                                              {fieldName: "cmdsize", fieldType: "unsigned int"},
                                              {fieldName: "ilocalsym", fieldType: "unsigned int"},
                                              {fieldName: "nlocalsym", fieldType: "unsigned int"},
                                              {fieldName: "iextdefsym", fieldType: "unsigned int"},
                                              {fieldName: "nextdefsym", fieldType: "unsigned int"},
                                              {fieldName: "iundefsym", fieldType: "unsigned int"},
                                              {fieldName: "nundefsym", fieldType: "unsigned int"},
                                              {fieldName: "tocoff", fieldType: "unsigned int"},
                                              {fieldName: "ntoc", fieldType: "unsigned int"},
                                              {fieldName: "modtaboff", fieldType: "unsigned int"},
                                              {fieldName: "nmodtab", fieldType: "unsigned int"},
                                              {fieldName: "extrefsymoff", fieldType: "unsigned int"},
                                              {fieldName: "nextrefsyms", fieldType: "unsigned int"},
                                              {fieldName: "indirectsymoff", fieldType: "unsigned int"},
                                              {fieldName: "nindirectsyms", fieldType: "unsigned int"},
                                              {fieldName: "extreloff", fieldType: "unsigned int"},
                                              {fieldName: "nextrel", fieldType: "unsigned int"},
                                              {fieldName: "locreloff", fieldType: "unsigned int"},
                                              {fieldName: "nlocrel", fieldType: "unsigned int"}]);

__defineSyntheticType("___symtab_command", [{fieldName: "cmd", fieldType: "unsigned int"},
                                            {fieldName: "cmdsize", fieldType: "unsigned int"},
                                            {fieldName: "symoff", fieldType: "unsigned int"},
                                            {fieldName: "nsyms", fieldType: "unsigned int"},
                                            {fieldName: "stroff", fieldType: "unsigned int"},
                                            {fieldName: "strsize", fieldType: "unsigned int"}]);
 
var __guidType = __defineSyntheticType("GUID", [{fieldName: "Data1", fieldType: "unsigned int"},
...
class __PEImageInformation
{
    ...
    get FileHeader()
    {
        ...
        var signature = host.memory.readMemoryValues(fileOffset, 1, 4, false, this.__module)[0];
...
{
    return [new host.namespacePropertyParent(__ModuleAttributes, "Debugger.Models.Module", "Debugger.Models.Module.Attributes", "Attributes"),
            new host.namespacePropertyParent(__ModuleInformation, "Debugger.Models.Module", "Debugger.Models.Module.Contents", "Contents"),
