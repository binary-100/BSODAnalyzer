...
**Updated:** 2026-09-05 · **Version:** 6.5.31 · **Session status:** WQ-003 BV-9 landed · **Upgrade planning:** Native dump still not promoted
...
- **Active WQ:** **WQ-003** — **BV-9** DUP inner_versions on all OEM rows ☑ (6.5.31); **BV-10** next
