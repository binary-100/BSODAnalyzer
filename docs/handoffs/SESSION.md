...
**Updated:** 2026-09-05 · **Version:** 6.5.32 · **Session status:** WQ-003 BV-10 landed · **Upgrade planning:** Native dump still not promoted
...
- **Active WQ:** **WQ-003** — **BV-10** selective install generalization ☑ (6.5.32); **BV-11** next
